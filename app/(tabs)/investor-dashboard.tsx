...
const QUICK_STATS = [
  ...
  { label: 'New Pitches', value: '8', color: COLORS.accent },
  { label: 'Connections', value: '45', color: COLORS.primary },
];
          ...
          <View style={styles.pitchesList}>
            {RECENT_PITCHES.map((pitch) => (
              <TouchableOpacity
                ...
                onPress={() => router.push(`/(tabs)/funding/${pitch.id}`)}
                activeOpacity={0.7}>
                <View style={styles.pitchHeader}>
                  ...
                  <View style={styles.pitchInfo}>
                    ...
                    <Text style={styles.pitchDetails}>
                      {pitch.stage} • {pitch.industry} • {pitch.amount}
                    </Text>
                  </View>
                  {!pitch.viewed && (
                ...
                <View style={styles.pitchActions}>
                  <TouchableOpacity style={styles.viewButton}>
                    <Text style={styles.viewButtonText}>View Deck</Text>
                  </TouchableOpacity>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.actionsGrid}>
            <TouchableOpacity
              ...
              <Text style={styles.actionSubtitle}>View all opportunities</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.actionCard}
